...
define('EXCEL_READER_TYPE_FONT',	  0x0031);
define('EXCEL_READER_TYPE_PALETTE',	  0x0092);
...
define('EXCEL_READER_MSINADAY',		  86400);
define('EXCEL_READER_TYPE_HYPER',	     0x01b8);
define('EXCEL_READER_TYPE_COLINFO',	     0x7d);
define('EXCEL_READER_TYPE_DEFCOLWIDTH',  0x55);
define('EXCEL_READER_TYPE_STANDARDWIDTH', 0x99);
	...
	function _parse() {
		...
		while ($code != EXCEL_READER_TYPE_EOF) {
			switch ($code) {
				...
				case EXCEL_READER_TYPE_PALETTE:
	...
	function _parsesheet($spos) {
		...
		function _getCellDetails($spos,$numValue,$column) {
			...
			if ($type == 'date') {
				...
				$utcDays = floor($numValue - ($this->nineteenFour ? EXCEL_READER_UTCOFFSETDAYS1904 : EXCEL_READER_UTCOFFSETDAYS));
				$utcValue = ($utcDays) * EXCEL_READER_MSINADAY;
				...
				$totalseconds = floor(EXCEL_READER_MSINADAY * $fractionalDay);
